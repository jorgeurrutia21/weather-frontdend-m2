const ciudades = [
    {
        ...
        imagen: "assets/css/img/santiago.jpg",
    ...
    },
    {
        ...
        imagen: "assets/css/img/concepcion.jpg",
        dias: ["lunes", "martes", "miercoles", "jueves", "viernes", "sabado"],
    },
    {
        id: 4,
        ...
        imagen: "assets/css/img/laserena.jpg",
        dias: ["lunes", "martes", "miercoles", "jueves", "viernes", "sabado"],
    },
    {
        id: 5,
    ...
    },
    {
        ...
        imagen: "assets/css/img/temuco.jpg",
        dias: ["lunes", "martes", "miercoles", "jueves", "viernes", "sabado"],
    },
    {
        id: 7,
        ...
        imagen: "assets/css/img/puertomontt.jpg",
        dias: ["lunes", "martes", "miercoles", "jueves", "viernes", "sabado"],
    },
    {
        id: 8,
        ...
        imagen: "assets/css/img/puntaarenas.jpg",
        dias: ["lunes", "martes", "miercoles", "jueves", "viernes", "sabado"],
    },
    {
        id: 9,
        ...
        imagen: "assets/css/img/iquique.jpg",
        dias: ["lunes", "martes", "miercoles", "jueves", "viernes", "sabado"],
    },
    {
        id: 10,
        ...
        imagen: "assets/css/img/rancagua.jpg",
        dias: ["lunes", "martes", "miercoles", "jueves", "viernes", "sabado"],
    },
];
...
function renderCards() {
    ...
    ciudades.forEach((ciudad) => {
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <article class="card h-100 card-ciudad" data-id="${ciudad.id}">
